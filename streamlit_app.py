#!/usr/bin/env python3
"""
Core Affinity Lab v10 — Universal Trait + Member Profiles MEMORY SAFE
...
APP_VERSION = "v8"
BUILD_MARKER = "BUILD: core_affinity_lab_v10_DEPLOY_ALIAS_FIX__2026-06-17"

st.set_page_config(page_title="Core Affinity Lab v10", layout="wide")
st.title("Core Affinity Lab v10 — Universal Trait + Member Profiles MEMORY SAFE")
