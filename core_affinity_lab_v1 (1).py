#!/usr/bin/env python3
"""
Core Affinity Lab v9 — Universal Trait + Member Profiles MEMORY SAFE
...
APP_VERSION = "v8"
BUILD_MARKER = "BUILD: core_affinity_lab_v9_PROFILE_BUILDER_CRASH_FIX__2026-06-17"

st.set_page_config(page_title="Core Affinity Lab v9", layout="wide")
st.title("Core Affinity Lab v9 — Universal Trait + Member Profiles MEMORY SAFE")
...
st.sidebar.caption("v9 crash fix + memory-safe: mines with counters instead of giant exploded tables.")
...
run_btn = st.button("Run v9 universal trait/member profiler", type="primary", use_container_width=True)
